...
public class Poly2TriUtils {
	...
	/*
	 * class Pointbase; class Linebase;
	 * 
	 * template <class T, class KeyType> class SplayTree; typedef map<unsigned
	 * int, Pointbase*> PointbaseMap; typedef map<unsigned int, Linebase*>
	 * LineMap; typedef priority_queue<Pointbase> PQueue; typedef
	 * SplayTree<Linebase*, double> EdgeBST; typedef list<unsigned int>
	 * Monopoly; typedef list<Monopoly> Monopolys; typedef vector<unsigned int>
	 * Triangle; typedef list<Triangle> Triangles; typedef map<unsigned int,
	 * set<unsigned int> > AdjEdgeMap;
	 */

	// #define sqr(t) (t)*(t)

	// enum Type { UNKNOWN, INPUT, INSERT, START, END, MERGE, SPLIT, REGULAR_UP,
	// REGULAR_DOWN};
	...
	/**
	 * In original poly2tri there is an exact arithemtic from Jonathan Shewchuk
	 * ... sorry I didn't have time to reimplement that (also I don't know if
	 * you can reimplement it 1:1 ...)
	 */
