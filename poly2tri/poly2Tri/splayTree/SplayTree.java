...
public class SplayTree {
	...
	/**
	 * Find the maximum node smaller than or equal to the given key. This
	 * function specially designed for polygon Triangulation to find the direct
	 * left edge at event vertex;
	 */
	// void FindMaxSmallerThan( const KeyType& keys, BTreeNode<T, KeyType>*
	// &res);
	...
	/**
	 * Internal method to perform a top-down splay. x is the key of target node
	 * to splay around. t is the root of the subtree to splay.
	 * 
	 * @param keys
	 * @param t
	 * @return
