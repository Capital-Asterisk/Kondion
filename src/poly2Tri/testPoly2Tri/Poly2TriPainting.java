...
/**
 * It's as nasty as it could be ... slow as hell, but writing the code was fast
 * :D
 * 
 * @author Jimmy
 *
...
public class Poly2TriPainting extends JPanel {
	...
	protected int[] getPoint(double x, double y) {
		...
		int[] point = {
				(int) (Math
						.round(realCenter[0] - center[0] * xSize + x * xSize)),
				(int) (Math
						.round(realCenter[1] + center[1] * ySize - y * ySize))};
